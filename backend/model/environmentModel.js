...
exports.fetchAllFlags = async (envId)=>{
    const response = await db.query(`
        SELECT f.id, f.name, f.key, f.type, f.description, fv.environment_id, fv.is_enabled, f.default_value, fv.rollout_percentage, fv.targeting_attribute, fv.targeting_value, fv.targeting_return_value, fv.updated_at
        FROM flag_values fv
